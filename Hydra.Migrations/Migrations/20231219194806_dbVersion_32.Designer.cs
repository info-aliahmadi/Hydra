...
namespace Hydra.Migrations.Migrations
{
    ...
    [Migration("20231219194806_dbVersion_32")]
    partial class dbVersion_32
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hydra.Cms.Core.Domain.Subscribe", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Hydra.Cms.Core.Domain.SubscribeLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hydra.Cms.Core.Domain.Subscribe", b =>
                {
                    b.HasOne("Hydra.Cms.Core.Domain.SubscribeLabel", "SubscribeLabel")
                        .WithMany("Subscribes")
